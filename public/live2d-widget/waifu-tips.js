...
!(function () {
  ...
  const n = {
    ...
    asteroids: {
      ...
      callback: () => {
        if (window.Asteroids)
          ...
          (e.src =
            "https://cdn.jsdelivr.net/gh/tennisatw/asteroids/asteroids.js"),
    ...
    info: {
      ...
      callback: () => {
        open("https://github.com/tennisatw/live2d-widget");
      },
    },
    quit: {
  ...
  window.initWidget = function (e, t) {
    "string" == typeof e && (e = { waifuPath: e, apiPath: t }),
      document.body.insertAdjacentHTML(
        "beforeend",
        '<div id="waifu-toggle">\n<span>|&emsp;&emsp;&emsp;Tennisbot</span>\n</div>'
      );
